...
import { initiateUpload, uploadPart, completeUpload, uploadStatus, chunkStatus, deleteUpload } from "../controllers/file/chunkupload.file.controller.js";
...
router.delete("/:uploadId",JwtAuth.verifyToken,deleteUpload)
